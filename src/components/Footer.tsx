      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        <div className="border-t border-white border-opacity-20 pt-8">
          ...
          <p className="text-xs opacity-50 mt-4">
            © 2024 - Invitación de Boda Digital
          </p>
        </div>
      </div>
    </footer>
